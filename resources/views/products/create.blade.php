                    ...
                    <div class="card-body">
                        ...
                        <div class="row gx-3 mb-3">
                            <div class="row">
                                <!-- Input Buying Price -->
                                <div class="col-md-6">
                                    <label for="buying_price" class="small mb-1">Buying Price</label>
                                    <input
                                        type="number"
                                        id="buying_price"
                                        name="buying_price"
                            ...
                            <!-- JavaScript untuk Menghitung Harga Jual -->
                            <script>
                                function calculateSellingPrice() {
                                    let buyingPrice = document.getElementById('buying_price').value;
                                    document.getElementById('selling_price').value = buyingPrice ? Math.round(buyingPrice * 1.5) : ''; // Kalkulasi dengan pembulatan
                                }
                            </script>
                            <!-- Form Group (stock) -->
                            <div class="mb-3">
                            ...
                            <!-- Form Group (stock awal) -->
                            <div class="mb-3">
                                <label class="small mb-1" for="stock_awal">Stock awal<span class="text-danger">*</span></label>
                                <input class="form-control form-control-solid @error('stock_awal') is-invalid @enderror" id="stock_awal" name="stock_awal" type="text" placeholder="" value="{{ old('stock_awal') }}" autocomplete="off" />
                                @error('stock_awal')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
