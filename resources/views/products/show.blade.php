                ...
                <div class="card-body">
                    ...
                    <div class="row gx-3 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-control form-control-solid">{{ number_format($product->buying_price, 0, ',', '.') }}</div>
                        </div>
                        <!-- Form Group (selling price) -->
                        <div class="col-md-6">
                            <label class="small mb-1">Selling Price</label>
                            <div class="form-control form-control-solid">{{ number_format($product->selling_price, 0, ',', '.') }}</div>
                        </div>
                    </div>
                    <!-- Form Group (stock) -->
                    <div class="mb-3">
                        <label class="small mb-1">Stock</label>
                        <div class="form-control form-control-solid">{{ number_format($product->stock, 0, ',', '.') }}</div>
                    </div>
