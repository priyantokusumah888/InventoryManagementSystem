<nav class="sidenav shadow-right sidenav-light">
    <div class="sidenav-menu">
        <div class="nav accordion" id="accordionSidenav">
            ...
            <div class="sidenav-menu-heading">Master Barang</div>
            ...
            <div class="sidenav-menu-heading">Laporan Transaksi</div>
            ...
            <a class="nav-link {{ Request::is('orders/complete*') ? 'active' : '' }}" href="{{ route('order.completeOrders') }}">
                <div class="nav-link-icon"><i class="fa-solid fa-share"></i></div>
                Laporan Keluar
            </a>
            <a class="nav-link {{ Request::is('inventory*') ? 'active' : '' }}" href="{{ route('inventories.index') }}">
                <div class="nav-link-icon"><i class="fa-solid fa-boxes"></i></div>
                Laporan Stock
            </a>
