...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/orders/report', [OrderController::class, 'dailyOrderReport'])->name('order.dailyOrderReport');
    Route::get('/orders/report/export', [OrderController::class, 'getOrderReport'])->name('order.getOrderReport');
    Route::post('/orders/report/export', [OrderController::class, 'exportOrderReport'])->name('order.exportOrderReport');
    ...
    Route::get('/inventory/report/export', [InventoryController::class, 'getInventoriesReport'])->name('inventories.getInventoriesReport');
    Route::post('/inventory/report/export', [InventoryController::class, 'exportInventoriesReport'])->name('inventories.exportInventoriesReport');
});
